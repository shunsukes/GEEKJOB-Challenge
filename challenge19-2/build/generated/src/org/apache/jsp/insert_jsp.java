...
public final class insert_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if(request.getParameter("mode") != null && request.getParameter("mode").equals("REINPUT")){
      ...
      out.write("        名前:\n");
      out.write("        <!-- 確認画面[insertconfirm.jsp]から戻ってきた場合(変数 reInputがtrue)、フォームを入力済にする -->\n");
 ...
 for(int i = 1; i <= 3; i++) { 
      out.write("\n");
      out.write("        <!-- [JumsHelper.java] jh.exTypenum(i)：種別は数字で取り扱っているので画面に表示するときは日本語に変換 -->\n");
...
if(reInput && udb.getType() == i) { out.print("checked = \"checked\""); } 
 ...
 if(reInput) { out.print(udb.getComment()); } 
      ...
      out.write("\">\n");
      out.write("        <!-- 入力情報を[InsertConfirm.java]へPOSTで送信するボタン -->\n");
